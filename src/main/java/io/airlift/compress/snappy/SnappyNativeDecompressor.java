        ...
        implements SnappyDecompressor
{
    ...
    public int decompress(byte[] input, int inputOffset, int inputLength, byte[] output, int outputOffset, int maxOutputLength)
    {
        ...
        return getDecompressSize(inputSegment, outputSegment);
    }
    ...
    public void decompress(ByteBuffer inputBuffer, ByteBuffer outputBuffer)
    {
        ...
        int decompressSize = getDecompressSize(inputSegment, outputSegment);
        outputBuffer.position(outputBuffer.position() + decompressSize);
    }

    public int getDecompressSize(MemorySegment inputSegment, MemorySegment outputSegment)
    {

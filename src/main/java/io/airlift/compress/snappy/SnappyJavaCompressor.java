...
public non-sealed class SnappyJavaCompressor
        implements SnappyCompressor
{
    ...
    {
        // this could be supported if necessary
        throw new UnsupportedOperationException("Java compressor does not support memory segment");
    }
